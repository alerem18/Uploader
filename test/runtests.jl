...
# !!! Main.UserApp is configured as an alias for Main.Uploader and you might encounter it in some tests
using Main.Uploader, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Uploader tests" begin
  @includetests ARGS
end
